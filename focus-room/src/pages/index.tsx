        ...
        <div className="row">
          <div className="col">
            <div id="primary-content" className="row">
              ...
              <ul className="my-4 ms-2 me-2 list-group list-group-horizontal-sm">
              ...
              <div className="ms-2 me-2 mt-3 mb-3 border border-dark">
                ...
                <h3 className="mt-2 ms-3 py-3 py-2 fw-light text-center">
                  Focus Room
                </h3>
              </div>

              <h3 className="mt-2 ms-2 fw-light">- 集中</h3>
              <p className="mt-2 py-4 ms-2 me-2 h6 fw-light rounded secondary-background-color">
                集中して作業に取り組みたいとき一人でするよりも友達としたり、カフェでしたほうがはかどりませんか？
                一人でも複数人でも集中できるそんな
                <span className="fw-bold">部屋</span>を共有することができます
              </p>

              <h3 className="mt-2 ms-2 fw-light">- 部屋</h3>
              <p className="mt-2 py-4 ms-2 me-2 h6 fw-light rounded secondary-background-color">
